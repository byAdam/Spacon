summon spacon:teleporter_marker_init ~ ~ ~ spacon:teleporter_red
scoreboard players operation @e[type=spacon:teleporter_marker,c=1] spacon_tper_tmp = red spacon_tper_c
...
scoreboard players operation red spacon_tper_c += @e[type=spacon:teleporter_marker,c=1] spacon_tper_c